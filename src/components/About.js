...
const About = () => 
    <div className="about">
        <h1><img src="chili-logo.png" alt="logo"/>WELCOME TO HEATMAKERS<img src="chili-logo.png" alt="logo"/></h1>
        <h2>Create your own hot sauce right here!</h2>
        <p>The purpose of this website is to allow customers to create personalized hot sauces in small batches.
